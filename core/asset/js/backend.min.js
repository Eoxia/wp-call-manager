 ...
 * @return {void}
 */
window.eoxiaJS.callManager.init = function() {
	jQuery( '.wpeo-wrap iframe' ).css( 'height', jQuery( window ).height() + 'px' );
};
...
window.eoxiaJS.callManager.handleCall.init = function() {
	jQuery( document ).on( 'click', '.yop form span', window.eoxiaJS.callManager.handleCall.selectUser );
	jQuery( document ).on( 'click', 'li.autocomplete-result', window.eoxiaJS.callManager.handleCall.selectCustomers );
	jQuery( document ).on( 'click', 'span.wpeo-button.button-main.ajou_client', window.eoxiaJS.callManager.handleCall.newCustomers );
};
