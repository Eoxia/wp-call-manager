...
<div class="wrap">
	<br><br>
	<div> <table border="1" cellspacing="0" cellpadding="5" style="text-align: center; table-layout: fixed; margin: 0 auto;"> <tr style="background-color: #BBBBBB;"> <th> <?php echo esc_html( 'Résumé des appels', 'call-manager' ); ?> </th> </tr> </table> </div>
	<div class="wrap"><br>
		<table border="2" cellspacing="0" cellpadding="1" style="text-align: center; table-layout: fixed; margin: 0 auto;" >
<tr style="background-color: #BBBBBB;"><th> <?php echo esc_html( 'Vous avez des personnes à rappeller', 'call-manager' ); ?></th><th></th><th></th><th></th><th></th><th></th><th></th> </tr>
